...
IMPORTANT: GraphQL definiert, `wie` du Daten abfragen oder manipulieren kannst – `nicht`, wie diese Daten transportiert werden.
...
* gRPC – in performanteren Microservice-Umgebungen
